...
<div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <input id="categoryId0" value="${article.categoryId}" type="hidden">
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="ibox-content">
                                <form method="get" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="title" value="${article.title}" class="form-control" placeholder="请输入标题">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        	<script id="editor" type="text/plain">${article.contentToString}</script>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
	...
	<script type="text/javascript">
		$(document).ready(function () {
        	...
        	//初始化分类
        	var categoryId = $("#categoryId0").val();
